...
{    
    ...
    /// 月末内部受付（部品）
    /// </summary>
    public partial class F207E_InsideAcceptanceParts : BaseForm
    {
        ...
        public F207E_InsideAcceptanceParts(string fId) : base(fId)
        {
            InitializeComponent();
        ...
        /// ロード処理
        /// </summary>
        private void F207E_InsideAcceptanceParts_Load(object sender, EventArgs e)
        {
            try
            {
                // 月末
        ...
        private void partsCodeC1TextBox_Validated(object sender, EventArgs e)
        {
            try
            {
                ...
                inDateC1DateEdit.Value = endDate.ToShortDateString();
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetGroupComboListByUser()
        {
            ...
            url += $"Solution/S036/F207E/GetGroupComboListByUser?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg) UpdateIOFileAPI()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F207E/CreateIOFile?sid={solutionIdShort}&fid={formIdShort}";
