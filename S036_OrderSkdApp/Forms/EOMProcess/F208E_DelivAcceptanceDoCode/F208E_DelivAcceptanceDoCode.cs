...
namespace S036_OrderSkdApp
{
    ...
    /// 月末納入受付（伝票番号）
    /// </summary>
    public partial class F208E_DelivAcceptanceDoCode : BaseForm
    {
        #region ＜フィールド＞ 
        /// <summary>
        /// 処理年月　開始日
        ...
        public F208E_DelivAcceptanceDoCode(string fId) : base(fId)
        {
            InitializeComponent();
            this.titleLabel.Text = "月末納入受付（伝票番号）";
        }

        /// <summary>
        /// ロード処理
        /// </summary>
        private void F208E_DelivAcceptanceDoCode_Load(object sender, EventArgs e)
        {
            try
            {
                // 月末
                ...
                AddControlListII(inDateC1DateEdit, null, endDate.ToShortDateString(), true, enumCate.Key);
                ...
                AddControlListII(entryDateC1TextBox, null, endDate.ToShortDateString(), false, enumCate.Key);
        ...
        private void DisplayClear(string cate = "")
        {
            ...
            inDateC1DateEdit.Value = endDate;
            insideTransDateC1DateEdit.Value = endDate;
        ...
        private void GetGroupCode()
        {
            ...
            var isOk = DateTime.TryParse(result.Table.Rows[0].Field<string>("処理年月"), out var date);
            if (isOk == false)
            {
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetGroupComboListByUser()
        {
            ...
            url += $"Solution/S036/F208E/GetGroupComboListByUser?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetFirstProdCheckOK(string partsCode, string supCode)
        {
            // 必要なパラメータ設定済
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetFirstProdCheckOK?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, int Count, DataTable Table) FirstProdCheckApi(bool lot)
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetFirstProdCheckMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, DataTable Table) GetNextProcessInfoApi()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetNextProcessInfo?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, int Count) PartsCheckApi()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetPartsCheck?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg) UpdateIOFile()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/CreateDelivAcceptance?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg) UpdateOrdDetail()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/UpdateManufactInstructionMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) UpdateIOFilePrint()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/UpdateIOFilePrint?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetBOMMst()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetBOMMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetManufactFile(string jyuyoyosokuCode)
        {
            // 必要なパラメータ設定済
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetManufactFile?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetProcessMst()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F208E/GetProcessMst?sid={solutionIdShort}&fid={formIdShort}";
