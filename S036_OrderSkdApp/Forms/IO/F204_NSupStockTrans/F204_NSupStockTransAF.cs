...
namespace S036_OrderSkdApp
{
    ...
    /// 有償支給発行（一般）
    /// </summary>
    public class F204_NSupStockTransAF
    {
        ...
        public (bool IsOk, DataTable Table) GetIONSupStockTrans(string groupCode)
        {
            string sql =
            "SELECT " +
        ...
        */
        ...
        /// 住所録マスタ情報取得
        /// </summary>
        /// <param name="cusCode">会社コード</param>
        /// <returns></returns>
        public (bool IsOk, DataTable Table) GetSansoMainAddressMst(string cusCode)
        {
            ...
            /*
            apiParam.RemoveAll();
            apiParam.Add("cusCode", new JValue(cusCode));
