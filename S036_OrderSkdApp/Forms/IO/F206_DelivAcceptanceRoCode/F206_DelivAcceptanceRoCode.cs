...
namespace S036_OrderSkdApp
{
    ...
    /// 納入受付（注番）
    /// </summary>
    public partial class F206_DelivAcceptanceRoCode : BaseForm
    {
        #region ＜フィールド＞ 
        ...
        public F206_DelivAcceptanceRoCode(string fId) : base(fId)
        {
            InitializeComponent();
            this.titleLabel.Text = "納入受付（注番）";
        }

        /// <summary>
        /// ロード処理
        /// </summary>
        private void F206_DelivAcceptanceRoCode_Load(object sender, EventArgs e)
        {
            try
            {
                // 左パネル
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetGroupComboListByUser()
        {
            ...
            url += $"Solution/S036/F206/GetGroupComboListByUser?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetFirstProdCheckOK()
        {
            // 必要なパラメータ設定済
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetFirstProdCheckOK?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private void GetFirstProdChk()
        {
            ...
            if (result2.Count >= 1)
            {
                firstProdCheckFlg = result2.Table.Rows[0]["firstProdCheckF"].ToString() ?? "";
        ...
        private (bool IsOk, bool ReLogin, int Count, DataTable Table) FirstProdCheckApi(bool lot)
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetFirstProdCheckMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, int Count) PartsCheckApi()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetPartsCheck?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, DataTable Table) GetNextProcessInfoApi()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetNextProcessInfo?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg) UpdateOrdDetail()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/UpdateManufactInstructionMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) UpdateIOFile()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/UpdateIOFile?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetProcessMst()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetProcessMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetBOMMst()
        {
            ...
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetBOMMst?sid={solutionIdShort}&fid={formIdShort}";
        ...
        private (bool IsOk, bool ReLogin, string Msg, DataTable Table) GetManufactFile(string jyuyoyosokuCode)
        {
            // 必要なパラメータ設定済
            string url = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"];
            url += $"Solution/S036/F206/GetManufactFile?sid={solutionIdShort}&fid={formIdShort}";
