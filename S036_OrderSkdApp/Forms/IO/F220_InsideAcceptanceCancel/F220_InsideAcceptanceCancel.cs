...
namespace S036_OrderSkdApp
{
    ...
    /// 内部受付返品（部品）
    /// </summary>
    public partial class F220_InsideAcceptanceCancel : BaseForm
    {
        #region ＜フィールド＞ 
        ...
        /// WEBAPI接続先
        /// </summary>
        private string apiUrl = System.Configuration.ConfigurationManager.AppSettings["connectionWebAPIURL"] + "Solution/S036/F220/";
        ...
        public F220_InsideAcceptanceCancel(string fId) : base(fId)
        {
            InitializeComponent();
        ...
        /// ロード処理
        /// </summary>
        private void F220_InsideAcceptanceCancel_Load(object sender, EventArgs e)
        {
            try
            {
